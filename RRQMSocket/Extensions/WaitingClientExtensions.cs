...
namespace RRQMSocket
{
    ...
    /// </summary>
    public static class WaitingClientExtensions
    {
        /// <summary>
        /// WaitingClient
        /// </summary>
        public static readonly DependencyProperty WaitingClientProperty =
            DependencyProperty.Register("WaitingClient", typeof(object), typeof(WaitingClientExtensions), null);
            ...
            lock (this)
            {
                try
                {
                    ...
                    switch (this.m_waitData.Wait(timeout))
                    {
                        ...
                        default:
                            throw new RRQMException(RRQMCore.ResType.UnknownError.GetDescription());
                    }
                }
                finally
                {
