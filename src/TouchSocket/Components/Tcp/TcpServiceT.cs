...
namespace TouchSocket.Sockets
{
    ...
    public abstract class TcpService<TClient> : TcpServiceBase<TClient>, ITcpService<TClient> where TClient : TcpSessionClient
    {
        ...
        /// </summary>
        /// <param name="socketClient">发生断开连接事件的客户端</param>
        ...
        /// 即将断开连接(仅主动断开时有效)。
        /// </summary>
        /// <param name="socketClient">Tcp客户端对象</param>
        /// <param name="e">断开连接事件参数</param>
        ...
        /// </summary>
        /// <param name="socketClient">表示客户端的套接字对象。</param>
        ...
        /// </summary>
        /// <param name="socketClient">正在连接的客户端对象</param>
        ...
        /// </summary>
        /// <param name="socketClient">发生数据接收的客户端套接字实例。</param>
