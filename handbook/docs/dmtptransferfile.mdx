...
<CustomCodeBlock region="文件传输服务器请求文件"/>

### 6.4 服务器向客户端推送文件

服务器主动向客户端推送文件，必须通过Id，找到其`SessionClient`的派生类。

<CustomCodeBlock region="文件传输服务器推送文件"/>
...
<CustomCodeBlock region="文件传输添加路由策略"/>

【同意路由】

<CustomCodeBlock region="文件传输同意路由"/>
...
<CustomCodeBlock region="文件传输断点续传持久化"/>
...
<CustomCodeBlock region="文件传输拉取小文件"/>
...
<CustomCodeBlock region="文件传输推送小文件"/>
...
<CustomCodeBlock region="文件传输多线程配置"/>

### 10.2 多线程请求文件

<CustomCodeBlock region="文件传输多线程请求文件"/>

### 10.3 多线程推送文件

<CustomCodeBlock region="文件传输多线程推送文件"/>
...
<CustomCodeBlock region="文件传输多线程获取目标传输客户端Id"/>
...
<CardLink link="examples/Dmtp/FileTransferConsoleApp"/>