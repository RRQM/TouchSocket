...
namespace TouchSocket.Core.XREF.Newtonsoft.Json.Utilities.LinqBridge
{
    /// <summary>
    ...
    internal static partial class Enumerable
    {
        ...
        {
            if (count < 0)
                throw new System.ArgumentOutOfRangeException("count", count, null);
        ...
        {
            if (count < 0) throw new System.ArgumentOutOfRangeException("count", count, null);
        ...
        private static class Futures<T>
        {
            ...
            public static readonly Func<T> Undefined = () => { throw new System.InvalidOperationException(); };
        }
          ...
          int index)
        {
            ...
            if (index < 0)
                throw new System.ArgumentOutOfRangeException("index", index, null);
            ...
            catch (System.InvalidOperationException) // if thrown by First
            {
                throw new System.ArgumentOutOfRangeException("index", index, null);
            }
        }
        ...
        /// <summary>
        /// Returns a <see cref="System.Int64"/> that represents the total number
          ...
          this IEnumerable<TSource> source)
        {
            ...
            var array = source as System.Array;
            return array != null
                     ? array.LongLength
        ...
        /// <summary>
        /// Returns a <see cref="System.Int64"/> that represents how many elements
    ...
    internal sealed class OrderedEnumerable<T, K> : IOrderedEnumerable<T>
    {
        ...
        private readonly List<System.Comparison<T>> _comparisons;
        ...
        private OrderedEnumerable(IEnumerable<T> source, List<System.Comparison<T>> comparisons,
                                  Func<T, K> keySelector, IComparer<K> comparer, bool descending)
        {
            ...
            if (comparisons == null)
                comparisons = new List<System.Comparison<T>>( /* capacity */ 4);
    ...
    [System.Serializable]
    internal readonly struct Tuple<TFirst, TSecond> : System.IEquatable<Tuple<TFirst, TSecond>>
    {
