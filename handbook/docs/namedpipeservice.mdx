...
- 异步执行。
- 内存池支持
- 高性能（实测服务器单客户端单线程，每秒可接收数据流量可达6.5GB/s） [测试Demo]()。
...
<img src={require('../static/img/docs/namedpipeservice-2.gif').default} width="500" />
...
<img src={require('../static/img/docs/namedpipeservice-1.png').default} width="500" />
