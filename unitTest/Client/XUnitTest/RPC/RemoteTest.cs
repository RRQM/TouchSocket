...
namespace XUnitTest.RPC
{
    public class RemoteTest
    {
        ...
        {
            server.Test01_Performance(invokeOption);
        }
        ...
        public void Test02(IInvokeOption invokeOption)
        {
            for (int i = 0; i < 10; i++)
            {
                string returnValue = server.Test02_TaskString(i.ToString(), invokeOption);
        ...
        {
            ProxyClass1 proxyClass1 = server.Test03_GetProxyClass(invokeOption);
        ...
        {
            int value = server.Test04_In32DefaultValue(invokeOption: invokeOption);
            Assert.Equal(100, value);

            value = server.Test04_In32DefaultValue(int.MaxValue, invokeOption: invokeOption);
            Assert.Equal(int.MaxValue, value);
        }

        public void Test05(IInvokeOption invokeOption)
        {
            server.Test05_NoneReturnNoneParameter(invokeOption: invokeOption);
        }
        ...
        public void Test06(IInvokeOption invokeOption)
        {
            ...
            int age;
            string occupation;
            server.Test06_OutParameters(out name, out age, out occupation, invokeOption: invokeOption);
        ...
        {
            string name;
            server.Test07_OutStringParameter(out name, invokeOption: invokeOption);
            Assert.Equal("若汝棋茗", name);
        }
        ...
        {
            string name = "若汝棋茗";
            server.Test08_RefStringParameter(ref name, invokeOption: invokeOption);
            Assert.Equal("若汝棋茗ref", name);
        }

        public void Test09(IInvokeOption invokeOption)
        {
            Assert.True(server.Test09_Boolean(true, invokeOption: invokeOption));
            Assert.False(server.Test09_Boolean(false, invokeOption: invokeOption));
        }

        public void Test10(IInvokeOption invokeOption)
        {
            Assert.Null(server.Test10_StringDefaultNullValue(invokeOption: invokeOption));
        }

        public void Test11(IInvokeOption invokeOption)
        {
            Assert.Equal("RRQM", server.Test11_StringDefaultValue(invokeOption: invokeOption));
        }
        ...
        public void Test12(IInvokeOption invokeOption)
        {
            for (int i = 1; i < 10; i++)
            {
                Dictionary<int, string> dic = server.Test12_Dictionary(i, invokeOption: invokeOption);
        ...
        {
            server.Test13_Task(invokeOption: invokeOption);
        }
        ...
        public void Test14(IInvokeOption invokeOption)
        {
            for (int i = 1; i < 10; i++)
            {
                List<Class01> list = server.Test14_ListClass01(i, invokeOption: invokeOption);
        ...
        {
            Args args = server.Test15_ReturnArgs(invokeOption: invokeOption);
            Assert.NotNull(args);
        ...
        {
            Class04 class04 = server.Test16_ReturnClass4(10, "RRQM", invokeOption: invokeOption);
        ...
        {
            Assert.Equal(3.1415926, server.Test17_DoubleDefaultValue(invokeOption: invokeOption));
            Assert.Equal(10.0, server.Test17_DoubleDefaultValue(10.0, invokeOption: invokeOption));
        }

        public void Test18(IInvokeOption invokeOption)
        {
            Class01 class01 = server.Test18_Class1(new Class01() { Age = 10, Name = "RRQM" }, invokeOption: invokeOption);
        ...
        public void Test19(string id, IInvokeOption invokeOption)
        {
            for (int i = 0; i < 10; i++)
            {
                string msg = server.Test19_CallBacktcpRpcService(id, i, invokeOption: invokeOption);
        ...
        {
            int value = server.Test22_IncludeCaller(10, invokeOption: invokeOption);
            Assert.Equal(10, value);
        }

        public void Test25(IInvokeOption invokeOption)
        {
            int result = server.Test25_TestStruct(new StructArgs() { P1 = 10 }, invokeOption: invokeOption);
        ...
        public void Test30(string id, IInvokeOption invokeOption)
        {
            for (int i = 0; i < 10; i++)
            {
                string msg = server.Test30_CallBackHttpRpcService(id, i, invokeOption: invokeOption);
                Assert.Equal($"我今年{i}岁了", msg);
            }
        }
    }
