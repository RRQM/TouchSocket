...
namespace NamedPipeServiceConsoleApp
{
    ...
    class MyNamedPipePlugin : PluginBase, INamedPipeConnectedPlugin, INamedPipeDisconnectedPlugin, INamedPipeReceivedPlugin
    {
        ...
        async Task INamedPipeConnectedPlugin<INamedPipeClientBase>.OnNamedPipeConnected(INamedPipeClientBase client, ConnectedEventArgs e)
        {
            m_logger.Info("Connected");
            await e.InvokeNext();
        }

        async Task INamedPipeDisconnectedPlugin<INamedPipeClientBase>.OnNamedPipeDisconnected(INamedPipeClientBase client, DisconnectEventArgs e)
        {
