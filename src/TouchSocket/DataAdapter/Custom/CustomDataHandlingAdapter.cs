...
namespace TouchSocket.Sockets
{
    ...
    /// </summary>
    public abstract class CustomDataHandlingAdapter<TRequest> : TcpDataHandlingAdapter where TRequest : class, IRequestInfo
    {
        /// <summary>
        ...
        /// <summary>
        /// 即将执行<see cref="TcpDataHandlingAdapter.GoReceived(ByteBlock, IRequestInfo)"/>。
        /// </summary>
        /// <param name="request"></param>
