...
tags: [TouchSocket, furos, .net, .netcore, .net5, .net6]
---

import useBaseUrl from "@docusaurus/useBaseUrl";

**2021 年 07 月 15 日，微软发布了 `.NET 6 Preview 6` 版本，`TouchSocket` 在当天第一时间适配了该版本，并发布 `TouchSocket v3.0.0-rc.1` 版本。**

[TouchSocket .NET 6 Preview 6 源码地址](https://gitee.com/rrqm_home/TouchSocket/tree/3.0.0-rc.1/)
...
同时升级所有 `Microsoft` 和 `TouchSocket` 包为最新版本，`TouchSocket` 最新版本为：`v3.0.0-rc.1`。
...
`TouchSocket v3.0.0-rc.1` 目前提供了所有类型的脚手架，版本号统一 `3.0.0-rc.1`。

安装脚手架，打开 `CMD/Powershell` 执行以下命令：

```bash showLineNumbers 
dotnet new --install TouchSocket.Template.Api::3.0.0-rc.1
```

创建项目

```bash showLineNumbers 
dotnet new TouchSocketapi -n TouchSocketNET6
```
