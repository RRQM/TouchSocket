...
namespace WebApiProxy
{
    ...
    public class ApiServer : IApiServer
    {
        ...
        public System.Int32 SumCallContext(System.Int32 a, System.Int32 b, IInvokeOption invokeOption = default)
        {
            ...
            object[] @_parameters = new object[] { a, b };
            System.Int32 returnData = (System.Int32)this.Client.Invoke("GET:/apiserver/sumcallcontext?a={0}&b={1}", typeof(System.Int32), invokeOption, @_parameters);
            return returnData;
        }
        ///<summary>
        ///无注释信息
        ...
        public async Task<System.Int32> SumCallContextAsync(System.Int32 a, System.Int32 b, IInvokeOption invokeOption = default)
        {
            ...
            object[] parameters = new object[] { a, b };
            return (System.Int32)await this.Client.InvokeAsync("GET:/apiserver/sumcallcontext?a={0}&b={1}", typeof(System.Int32), invokeOption, parameters);
        }
    ...
    public static class ApiServerExtensions
    {
        ...
        {
            object[] @_parameters = new object[] { a, b };
            System.Int32 returnData = (System.Int32)client.Invoke("GET:/apiserver/sumcallcontext?a={0}&b={1}", typeof(System.Int32), invokeOption, @_parameters);
            return returnData;
        }
        ///<summary>
        ///无注释信息
        ...
        {
            object[] parameters = new object[] { a, b };
            return (System.Int32)await client.InvokeAsync("GET:/apiserver/sumcallcontext?a={0}&b={1}", typeof(System.Int32), invokeOption, parameters);
        }
