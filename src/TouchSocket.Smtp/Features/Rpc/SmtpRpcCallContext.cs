...
namespace TouchSocket.Smtp.Rpc
{
    ...
    /// SmtpRpcCallContext
    /// </summary>
    public class SmtpRpcCallContext : ISmtpRpcCallContext
    {
        ...
        /// <inheritdoc/>
        public SerializationType SerializationType => this.SmtpRpcPackage == null ? (SerializationType)byte.MaxValue : this.SmtpRpcPackage.SerializationType;

        /// <inheritdoc/>
        public SmtpRpcPackage SmtpRpcPackage { get; internal set; }
