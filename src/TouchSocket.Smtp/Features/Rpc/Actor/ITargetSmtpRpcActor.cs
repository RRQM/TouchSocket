...
namespace TouchSocket.Smtp.Rpc
{
    ...
    /// ITargetSmtpRpcActor
    /// </summary>
    internal class ITargetSmtpRpcActor : IRpcClient
    {
        private readonly ISmtpRpcActor m_rpcActor;
        ...
        public ITargetSmtpRpcActor(string targetId, ISmtpRpcActor rpcActor)
        {
