...
namespace TouchSocket.Sockets
{
    ...
    public static class TouchSocketConfigExtension
    {
        ...
        public static readonly DependencyProperty BufferLengthProperty =
            DependencyProperty.Register("BufferLength", typeof(int), typeof(TouchSocketConfig), 1024 * 64);
        ...
        public static readonly DependencyProperty ReceiveTypeProperty =
            DependencyProperty.Register("ReceiveType", typeof(ReceiveType), typeof(TouchSocketConfig), ReceiveType.Auto);
