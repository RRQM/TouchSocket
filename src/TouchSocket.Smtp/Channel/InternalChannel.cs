...
namespace TouchSocket.Smtp
{
    ...
    internal partial class InternalChannel : DisposableObject, ISmtpChannel
    {
        private readonly SmtpActor m_actor;
        ...
        public InternalChannel(SmtpActor client, string targetId, Metadata metadata)
        {
            this.m_actor = client;
