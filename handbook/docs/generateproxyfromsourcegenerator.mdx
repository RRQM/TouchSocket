...
程序集：[TouchSocket.CodeAnalyzer.dll](https://www.nuget.org/packages/TouchSocket.CodeAnalyzer)
...
上述功能需要再安装[TouchSocket.CodeAnalyzer](https://www.nuget.org/packages/TouchSocket.CodeAnalyzer)，该操作不会产生DLL依赖。
