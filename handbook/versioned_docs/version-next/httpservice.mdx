...
```csharp showLineNumbers
public class MyHttpPlug1 : PluginBase, IHttpPlugin<IHttpSessionClient>
{
...
```csharp showLineNumbers
public class MyHttpPlug2 : PluginBase, IHttpPlugin<IHttpSessionClient>
{
    public async Task OnHttpRequest(IHttpSessionClient client, HttpContextEventArgs e)
    {
        if (e.Context.Request.IsGet())
...
```csharp showLineNumbers
public class MyHttpPlug3 : PluginBase, IHttpPlugin<IHttpSessionClient>
{
    public async Task OnHttpRequest(IHttpSessionClient client, HttpContextEventArgs e)
    {
        if (e.Context.Request.IsGet())
...
```csharp showLineNumbers
public class MyHttpPlug4 : PluginBase, IHttpPlugin<IHttpSessionClient>
{
    public async Task OnHttpRequest(IHttpSessionClient client, HttpContextEventArgs e)
    {
