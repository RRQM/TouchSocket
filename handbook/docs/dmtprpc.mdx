...
<img src={require("../static/img/docs/dmtprpc-1.png").default} />

关于代理代码生成接口限制，请看[服务代理生成](../docs/generateproxyfromserver.mdx)或者[源服务代理生成](../docs/generateproxyfromsourcegenerator.mdx)
