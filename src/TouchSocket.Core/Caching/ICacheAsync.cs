...
public partial interface ICacheAsync<TKey, TValue>
{
    ...
    Task<bool> AddCacheAsync(ICacheEntry<TKey, TValue> entity, CancellationToken token = default);
    ...
    Task<bool> ContainsCacheAsync(TKey key, CancellationToken token = default);
    ...
    Task<ICacheEntry<TKey, TValue>> GetCacheAsync(TKey key, CancellationToken token = default);
    ...
    Task<bool> RemoveCacheAsync(TKey key, CancellationToken token = default);
    ...
    Task<bool> SetCacheAsync(ICacheEntry<TKey, TValue> entity, CancellationToken token = default);
}