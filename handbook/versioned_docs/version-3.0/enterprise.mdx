...
import Paypal from '@site/src/components/Paypal.js';
...
<Tabs
    ...
    values=
    {[
        { label: "微信支付",value: "tab1"},
        { label: "淘宝支持", value: "tab2" },
        { label: "Paypal", value: "tab3" },
    ]}
>
...
<TabItem value="tab2">
点击[淘宝链接](https://item.taobao.com/item.htm?spm=a2126o.success.result.1.382c4831HDDIvA&id=691874706840)。
</TabItem>
<TabItem value="tab3">
<Paypal></Paypal>
</TabItem>
