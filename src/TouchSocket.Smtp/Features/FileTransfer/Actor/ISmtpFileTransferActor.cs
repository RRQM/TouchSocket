...
{
    /// <summary>
    /// 能够基于SMTP协议提供文件传输功能的接口
    /// </summary>
    public interface ISmtpFileTransferActor : IActor
    {
        #region Id小文件
        ...
        /// <item>每次该操作，都应该对应一次<see cref="ISmtpFileTransferActor.FinishedFileResourceInfo(FileResourceInfo, Metadata, int, CancellationToken)"/></item>
        /// </list>
        /// </summary>
        /// <param name="targetId">目标客户端Id</param>
        ...
        /// <list type="number">
        /// <item>完成该操作后，必须在设定时间（60秒）内至少完成一次文件块访问，不然该信息将变得无效，</item>
        /// <item>每次该操作，都必须对应一次<see cref="ISmtpFileTransferActor.FinishedFileResourceInfo(FileResourceInfo, Metadata, int, CancellationToken)"/></item>
        /// </list>
        /// </summary>
        /// <param name="targetId">目标客户端Id</param>
        /// <param name="savePath">保存路径</param>
