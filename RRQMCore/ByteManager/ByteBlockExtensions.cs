...
namespace RRQMCore.ByteManager
{
    ...
    public static class ByteBlockExtensions
    {
        ...
        {
            int value = RRQMBitConverter.Default.ToInt32(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 4;
            return value;
        }
        ...
        {
            byteBlock.Write(RRQMBitConverter.Default.GetBytes(value));
            return byteBlock;
        }
        ...
        {
            short value = RRQMBitConverter.Default.ToInt16(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 2;
            return value;
        }
        ...
        {
            long value = RRQMBitConverter.Default.ToInt64(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 8;
            return value;
        }
        ...
        {
            bool value = RRQMBitConverter.Default.ToBoolean(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 1;
            return value;
        }
        ...
        {
            char value = RRQMBitConverter.Default.ToChar(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 2;
            return value;
        }
        ...
        {
            double value = RRQMBitConverter.Default.ToDouble(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 8;
            return value;
        }
        ...
        {
            float value = RRQMBitConverter.Default.ToSingle(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 4;
            return value;
        }
        ...
        {
            ushort value = RRQMBitConverter.Default.ToUInt16(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 2;
            return value;
        }
        ...
        {
            uint value = RRQMBitConverter.Default.ToUInt32(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 4;
            return value;
        }
        ...
        {
            ulong value = RRQMBitConverter.Default.ToUInt64(byteBlock.Buffer, byteBlock.Pos);
            byteBlock.Pos += 8;
            return value;
        }
        ...
        {
            byteBlock.Write(RRQMBitConverter.Default.GetBytes(value.ToBinary()));
            return byteBlock;
        }
