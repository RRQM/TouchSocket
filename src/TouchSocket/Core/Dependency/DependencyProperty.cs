...
namespace TouchSocket.Core.Dependency
{
    ...
    public class DependencyProperty
    {
        ...
        private DependencyAction m_dependencyAction;
        ...
        /// 依赖行为
        /// </summary>
        public DependencyAction DependencyAction => this.m_dependencyAction;

        /// <summary>
        /// 注册依赖项属性。
        /// <para>依赖属性的默认值，可能会应用于所有的<see cref="IRRQMDependencyObject"/></para>
        /// </summary>
        ...
        /// <param name="valueType"></param>
        /// <param name="owner"></param>
        /// <param name="action">依赖项属性行为</param>
        /// <returns></returns>
        public static DependencyProperty Register(string propertyName, Type valueType, Type owner, DependencyAction action)
        {
            DependencyProperty dp = new DependencyProperty
            {
                m_name = propertyName,
