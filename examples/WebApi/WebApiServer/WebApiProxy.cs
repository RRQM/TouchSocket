...
String returnData=(String)Client.Invoke(typeof(String),"GET:/apiserver/downloadfile?id={1}",invokeOption, parameters);
return returnData;
}
///<summary>
///无注释信息
...
String returnData=(String)Client.Invoke(typeof(String),"POST:/apiserver/postcontent",invokeOption, null);
return returnData;
}
///<summary>
///无注释信息
