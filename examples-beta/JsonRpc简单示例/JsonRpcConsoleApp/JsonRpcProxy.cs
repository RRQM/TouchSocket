...
namespace JsonRpcProxy
{
    ...
    public class JsonRpcServer : IJsonRpcServer
    {
        ...
        public System.String TestJsonRpc1(System.String str, IInvokeOption invokeOption = default)
        {
            ...
            var parameters = new object[] { str };
            var returnData = (System.String)this.Client.Invoke(typeof(System.String), "TestJsonRpc1", invokeOption, parameters);
            return returnData;
        }
        ...
        public async Task<System.String> TestJsonRpc1Async(System.String str, IInvokeOption invokeOption = default)
        {
            ...
            var parameters = new object[] { str };
            return (System.String)await this.Client.InvokeAsync(typeof(System.String), "TestJsonRpc1", invokeOption, parameters);
        }
    }
    ...
    public static class JsonRpcServerExtensions
    {
        ...
        {
            var parameters = new object[] { str };
            var returnData = (System.String)client.Invoke(typeof(System.String), "TestJsonRpc1", invokeOption, parameters);
            return returnData;
        }
