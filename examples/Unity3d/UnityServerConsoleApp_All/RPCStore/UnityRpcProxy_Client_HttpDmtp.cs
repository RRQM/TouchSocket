...
namespace UnityRpcProxy
{
    public interface ITouch_HttpDmtp_Client_UnityRpcStore : TouchSocket.Rpc.IRemoteServer
    {
        ...
        System.Int32 RandomNumber(System.Int32 a, System.Int32 b, InvokeOption invokeOption = default);
        ///<summary>
        ///无注释信息
        ///</summary>
        /// <exception cref="System.TimeoutException">调用超时</exception>
    ...
    public class Touch_HttpDmtp_Client_UnityRpcStore : ITouch_HttpDmtp_Client_UnityRpcStore
    {
        ...
        /// <exception cref="TouchSocket.Rpc.RpcInvokeException">Rpc调用异常</exception>
        /// <exception cref="System.Exception">其他异常</exception>
        public System.Int32 RandomNumber(System.Int32 a, System.Int32 b, InvokeOption invokeOption = default)
        {
            if (this.Client == null)
            {
    ...
    public static class Touch_HttpDmtp_Client_UnityRpcStoreExtensions
    {
        ...
        /// <exception cref="TouchSocket.Rpc.RpcInvokeException">Rpc调用异常</exception>
        /// <exception cref="System.Exception">其他异常</exception>
        public static System.Int32 RandomNumber<TClient>(this TClient client, System.Int32 a, System.Int32 b, InvokeOption invokeOption = default) where TClient :
