...
namespace TouchSocket.NamedPipe
{
    ...
    public static class NamedPipeConfigExtension
    {
        ...
        /// <returns></returns>
        public static NamedPipeReconnectionPlugin<TClient> UseNamedPipeReconnection<TClient>(this IPluginManager pluginManager) where TClient : class, INamedPipeClient
        {
        ...
        /// <returns></returns>
        public static NamedPipeReconnectionPlugin<INamedPipeClient> UseNamedPipeReconnection(this IPluginManager pluginManager, int tryCount = 10, bool printLog = false, int sleepTime = 1000, Action<INamedPipeClient> successCallback = null)
        {
        ...
        /// <returns></returns>
        public static NamedPipeReconnectionPlugin<INamedPipeClient> UseNamedPipeReconnection(this IPluginManager pluginManager, TimeSpan sleepTime,
