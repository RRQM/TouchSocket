...
所有以`TouchSocket`开头的程序集都是在开源网站开源的，只要你循序[使用协议](../docs/description.mdx)，即可完全免费使用。
...
### 2.1 Tcp组件
- [轮询式断线重连](./reconnection.mdx#三使用pollingkeepalive插件-企业版) <Tag>企业版</Tag>
- [TLV适配器](./tlvdatahandlingadapter.mdx) <Tag>企业版</Tag>
- 其余功能

### 2.2 NAT组件
- [转发客户端重连](./natservice.mdx#四转发断线重连-企业版) <Tag>企业版</Tag>
- 其余功能
...
- [远程文件操作](./remotefilecontrol.mdx) <Tag>企业版</Tag>
- [远程流访问](./dmtpremotestream.mdx) <Tag>企业版</Tag>
- 文件传输功能
- [多线程文件传输](./dmtptransferfile.mdx) <Tag>企业版</Tag>
- [小文件传输](./dmtptransferfile.mdx)
- 文件传输限速 <Tag>企业版</Tag>
- [EventBus功能](https://www.yuque.com/rrqm/touchsocket/ipt4zr) <Tag>企业版</Tag>
- Redis
...
上述的功能中，所有带有 <Tag>企业版</Tag> 的标识，均为`TouchSocketPro`包含的内容。其余功能`TouchSocket`也均支持。
...
目前TouchSocketPro在进行限定版本免费使用活动。这意味着您只要使用的是特定版本（v1.4、v2.0-beta），则享有永久免费使用的权利。使用方法如上“限时测试”一样。
...
<img src={require('../static/img/docs/enterprise-1.jpg').default} width="500" />
