...
System.Boolean returnData=Client.Invoke<System.Boolean>("touchrpcwebapplication.rpcproviders.myrpcserver.login",invokeOption, parameters);
return returnData;
}
///<summary>
///登录
...
object[] parameters = new object[]{account,password};
return Client.InvokeAsync<System.Boolean>("touchrpcwebapplication.rpcproviders.myrpcserver.login",invokeOption, parameters);
}
...
System.Int32 returnData=Client.Invoke<System.Int32>("touchrpcwebapplication.rpcproviders.myrpcserver.performance",invokeOption, parameters);
return returnData;
}
///<summary>
///性能测试
...
object[] parameters = new object[]{a};
return Client.InvokeAsync<System.Int32>("touchrpcwebapplication.rpcproviders.myrpcserver.performance",invokeOption, parameters);
}
