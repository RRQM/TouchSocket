...
public sealed partial class ByteBlock
{
    ...
    public IEnumerable<T> ToTs<T>(EndianType endianType) where T : unmanaged
    {
        ...
        while (true)
        {
            ...
            yield return this.ReadT<T>(endianType);
        }
    }
