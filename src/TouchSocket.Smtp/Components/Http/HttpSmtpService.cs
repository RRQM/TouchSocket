...
namespace TouchSocket.Smtp
{
    ...
    /// HttpSmtpService
    /// </summary>
    public class HttpSmtpService : HttpSmtpService<HttpSmtpSocketClient>
    {
    }
    ...
    public partial class HttpSmtpService<TClient> : HttpService<TClient>, IHttpSmtpService where TClient : HttpSmtpSocketClient, new()
    {
        /// <summary>
        /// 连接令箭
        /// </summary>
        ...
        private SmtpActor PrivateOnRpcActorInit()
        {
            return new SmtpActor(this.m_allowRoute)
            {
