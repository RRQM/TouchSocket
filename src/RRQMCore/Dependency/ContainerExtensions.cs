...
namespace RRQMCore.Dependency
{
    ...
    public static class ContainerExtensions
    {
        ...
        public static void RegisterSingleton<TFrom, TTo>(this IContainer container, TTo instance)
              where TFrom : class
        ...
        /// <param name="instance"></param>
        public static void RegisterSingleton<TFrom, TTo>(this IContainer container, string key, TTo instance)
              where TFrom : class
              where TTo : class, TFrom
        {
        ...
        /// <param name="instance"></param>
        /// <param name="key"></param>
        public static void RegisterSingleton(this IContainer container, Type fromType, object instance, string key = "")
        {
        ...
        /// <typeparam name="TFrom"></typeparam>
        /// <typeparam name="TTO"></typeparam>
        public static void RegisterScoped<TFrom, TTO>(this IContainer container)
             where TFrom : class
             where TTO : class, TFrom
        {
        ...
        /// <param name="container"></param>
        /// <param name="key"></param>
        public static void RegisterScoped<TFrom, TTO>(this IContainer container, string key)
             where TFrom : class
             where TTO : class, TFrom
        {
        ...
        /// <param name="toType"></param>
        /// <param name="key"></param>
        public static void RegisterScoped(this IContainer container, Type fromType, Type toType, string key = "")
        {
