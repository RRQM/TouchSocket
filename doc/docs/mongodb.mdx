...
[https://gitee.com/rrqm_home/TouchSocket/pulls/423](https://gitee.com/rrqm_home/TouchSocket/pulls/423)
...
在 `TouchSocket` 框架中，已经推出 `MongoDB` 拓展包 [TouchSocket.Extras.DatabaseAccessor.MongoDB](https://www.nuget.org/packages/TouchSocket.Extras.DatabaseAccessor.MongoDB)。
