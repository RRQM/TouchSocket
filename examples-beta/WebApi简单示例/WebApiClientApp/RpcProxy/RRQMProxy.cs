...
namespace WebApiProxy
{
    ...
    public class Server : IServer
    {
        ...
        public System.Int32 Sum(System.Int32 a, System.Int32 b, IInvokeOption invokeOption = default)
        {
            ...
            var returnData = (System.Int32)this.Client.Invoke(typeof(System.Int32), "GET:/server/sumab?a={0}&b={1}", invokeOption, parameters);
            return returnData;
        }
        ...
        public async Task<System.Int32> SumAsync(System.Int32 a, System.Int32 b, IInvokeOption invokeOption = default)
        {
            ...
            var parameters = new object[] { a, b };
            return (System.Int32)await this.Client.InvokeAsync(typeof(System.Int32), "GET:/server/sumab?a={0}&b={1}", invokeOption, parameters);
        }
        ...
        public System.Int32 TestPost(MyClass myClass, IInvokeOption invokeOption = default)
        {
            ...
            var returnData = (System.Int32)this.Client.Invoke(typeof(System.Int32), "POST:/server/testpost", invokeOption, parameters);
            return returnData;
        }
        ...
        public async Task<System.Int32> TestPostAsync(MyClass myClass, IInvokeOption invokeOption = default)
        {
            ...
            var parameters = new object[] { myClass };
            return (System.Int32)await this.Client.InvokeAsync(typeof(System.Int32), "POST:/server/testpost", invokeOption, parameters);
        }
        ...
        public String DownloadFile(System.String id, IInvokeOption invokeOption = default)
        {
            ...
            var returnData = (String)this.Client.Invoke(typeof(String), "GET:/server/downloadfile?id={1}", invokeOption, parameters);
            return returnData;
        }
        ...
        public async Task<String> DownloadFileAsync(System.String id, IInvokeOption invokeOption = default)
        {
            ...
            var parameters = new object[] { id };
            return (String)await this.Client.InvokeAsync(typeof(String), "GET:/server/downloadfile?id={1}", invokeOption, parameters);
        }
        ...
        public String PostContent(IInvokeOption invokeOption = default)
        {
            ...
            var returnData = (String)this.Client.Invoke(typeof(String), "POST:/server/postcontent", invokeOption, null);
            return returnData;
        }
        ...
        public async Task<String> PostContentAsync(IInvokeOption invokeOption = default)
        {
            ...
            return (String)await this.Client.InvokeAsync(typeof(String), "POST:/server/postcontent", invokeOption, null);
        }
    }
    ...
    public static class ServerExtensions
    {
        ...
        {
            var parameters = new object[] { a, b };
            var returnData = (System.Int32)client.Invoke(typeof(System.Int32), "GET:/server/sumab?a={0}&b={1}", invokeOption, parameters);
            return returnData;
        }
        ...
        {
            var parameters = new object[] { myClass };
            var returnData = (System.Int32)client.Invoke(typeof(System.Int32), "POST:/server/testpost", invokeOption, parameters);
            return returnData;
        }
        ...
        {
            var parameters = new object[] { id };
            var returnData = (String)client.Invoke(typeof(String), "GET:/server/downloadfile?id={1}", invokeOption, parameters);
            return returnData;
        }
        ...
        TouchSocket.WebApi.IWebApiClient
        {
            var returnData = (String)client.Invoke(typeof(String), "POST:/server/postcontent", invokeOption, null);
            return returnData;
        }
