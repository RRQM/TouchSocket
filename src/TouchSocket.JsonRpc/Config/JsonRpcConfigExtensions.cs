...
namespace TouchSocket.Sockets
{
    ...
    public static class JsonRpcConfigExtensions
    {
        ...
        /// <returns></returns>
        public static TClient BuildWithJsonRpcClient<TClient>(this TouchSocketConfig config) where TClient : IJsonRpcClient,new()
        {
        ...
        public static readonly DependencyProperty<JRPT> JRPTProperty =
            DependencyProperty<JRPT>.Register("JRPT", JRPT.Tcp);
